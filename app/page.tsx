...
const quickLinks = ["배터리 전해질", "고체 전지", "H01M10", "JP2023-145892A"];
        ...
        <div className="mx-auto w-full max-w-4xl text-center">
          <div className="mb-8">
            ...
            <p className="mt-4 text-base text-brand-muted md:text-lg">
              일본 특허를 한국어 중심으로 검색하고, 결과와 상세 요약까지 한 번에 확인합니다.
            </p>
          </div>
        ...
        <div className="mt-16 grid gap-4 md:grid-cols-3">
          <div className="rounded-[1.75rem] border border-white/70 bg-white/80 p-6 shadow-card backdrop-blur">
            ...
            <p className="mt-3 text-sm leading-6 text-brand-muted">
              키워드, 출원인, 특허번호 검색과 출원일, IPC 조건을 함께 적용할 수 있습니다.
            </p>
          </div>
          <div className="rounded-[1.75rem] border border-white/70 bg-white/80 p-6 shadow-card backdrop-blur">
            <div className="text-sm font-semibold text-brand-blue">번역</div>
            <p className="mt-3 text-sm leading-6 text-brand-muted">
              제목은 목록에서 바로 한국어로 확인하고, 상세 페이지에서는 요약 번역까지 이어서 볼 수 있습니다.
            </p>
          </div>
          <div className="rounded-[1.75rem] border border-white/70 bg-white/80 p-6 shadow-card backdrop-blur">
